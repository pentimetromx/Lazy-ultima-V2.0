...
const firstMes = document.querySelector('#meses div:nth-child(1)')
...
let alertaFlecha = document.querySelector('#alerta-ui')
...
function agregarEmpleado() {
  if (flagEmpleado === false) {
    ...
    mostrarAlertaEnElemento('Regrese a la zona de edicion','31%','36.5%');
    return;
  }
